...
class JwtAuthenticationTest extends TestCase
{
    ...
    public function testAuthenticate(): void
    {
        ...
        self::assertSame('1', JwtAuthentication::tenantId());

        JwtAuthentication::overrideTenantId(2);
        self::assertSame('2', JwtAuthentication::tenantId());
    }

    public function testLocalToken(): void
    {
        $jwt = JwtAuthentication::createLocalToken(['DummyModel' => ['read']], '3');
        $this->provideJwt($jwt);
        JwtAuthentication::authenticate();

        self::assertSame('3', JwtAuthentication::tenantId());
    }
